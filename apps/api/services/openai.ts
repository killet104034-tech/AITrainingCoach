...
// Simplified survey data interface (domain-neutral)
...
export async function generateContent(surveyData: SurveyData): Promise<string> {
  try {
    // Simplified prompt with domain-neutral terminology
    const prompt = `You are an expert content generator. Based on the following information, create detailed personalized content in JSON format.

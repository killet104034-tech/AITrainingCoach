...
export function AdvancedSurveySection({ 
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="fatigue_single" id="squat-fatigue" />
              <label htmlFor="squat-fatigue" className="text-gray-300">Fatigue Single (예: 3x5 @160kg + 1x1 @175kg)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="squat-light" className="text-gray-300">RPE 8-9 (예: 1x3 @180kg, Heavy Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="moderate" id="squat-moderate" />
              <label htmlFor="squat-moderate" className="text-gray-300">RPE 6-7 (예: 1x5 @160kg, Medium Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="heavy" id="squat-heavy" />
              <label htmlFor="squat-heavy" className="text-gray-300">RPE 4-5 (예: 1x8 @140kg, Light Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="max" id="squat-max" />
              <label htmlFor="squat-max" className="text-gray-300">RPE 9-10 (예: 1x1 @190kg, Max Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="squat-weight-inc" className="text-gray-300">중량 증가 (예: 160kg→170kg→180kg, 5-10kg씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="reps_increase" id="squat-reps-inc" />
              <label htmlFor="squat-reps-inc" className="text-gray-300">Reps 증가 (중량 고정, 횟수 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="rpe_progression" id="squat-rpe-prog" />
              <label htmlFor="squat-rpe-prog" className="text-gray-300">RPE 점진 (예: RPE6→RPE8→RPE9, 1-2 RPE씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="squat-straight" className="text-gray-300">Straight Sets (5x5, 3x5 같은 고정 중량/Reps)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-freq-4" className="text-gray-300">4회</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="5" id="bench-freq-5" />
              <label htmlFor="bench-freq-5" className="text-gray-300">5회</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="6" id="bench-freq-6" />
              <label htmlFor="bench-freq-6" className="text-gray-300">6회</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-rpe-range" className="text-gray-300">RPE+Range (RPE와 해당 RPE 상하한선 중량 범위 설정)</label>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-ascending" className="text-gray-300">Ascending Set (예: 120kg-130kg-140kg 단계별 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="fatigue_single" id="bench-fatigue" />
              <label htmlFor="bench-fatigue" className="text-gray-300">Fatigue Single (예: 3x5 @120kg + 1x1 @135kg)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-light" className="text-gray-300">RPE 8-9 (예: 1x3 @140kg, Heavy Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="moderate" id="bench-moderate" />
              <label htmlFor="bench-moderate" className="text-gray-300">RPE 6-7 (예: 1x5 @120kg, Medium Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="heavy" id="bench-heavy" />
              <label htmlFor="bench-heavy" className="text-gray-300">RPE 4-5 (예: 1x8 @100kg, Light Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="max" id="bench-max" />
              <label htmlFor="bench-max" className="text-gray-300">RPE 9-10 (예: 1x1 @150kg, Max Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-weight-inc" className="text-gray-300">중량 증가 (예: 120kg→125kg→130kg, 2.5-5kg씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="reps_increase" id="bench-reps-inc" />
              <label htmlFor="bench-reps-inc" className="text-gray-300">Reps 증가 (중량 고정, 횟수 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="rpe_progression" id="bench-rpe-prog" />
              <label htmlFor="bench-rpe-prog" className="text-gray-300">RPE 점진 (예: RPE6→RPE8→RPE9, 1-2 RPE씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="bench-straight" className="text-gray-300">Straight Sets (5x5, 3x5 같은 고정 중량/Reps)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="deadlift-rpe-range" className="text-gray-300">RPE+Range (RPE와 해당 RPE 상하한선 중량 범위 설정)</label>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="deadlift-ascending" className="text-gray-300">Ascending Set (예: 200kg-210kg-220kg 단계별 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="fatigue_single" id="deadlift-fatigue" />
              <label htmlFor="deadlift-fatigue" className="text-gray-300">Fatigue Single (예: 3x5 @200kg + 1x1 @215kg)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="deadlift-light" className="text-gray-300">RPE 8-9 (예: 1x3 @220kg, Heavy Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="moderate" id="deadlift-moderate" />
              <label htmlFor="deadlift-moderate" className="text-gray-300">RPE 6-7 (예: 1x5 @200kg, Medium Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="heavy" id="deadlift-heavy" />
              <label htmlFor="deadlift-heavy" className="text-gray-300">RPE 4-5 (예: 1x8 @180kg, Light Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="max" id="deadlift-max" />
              <label htmlFor="deadlift-max" className="text-gray-300">RPE 9-10 (예: 1x1 @240kg, Max Weight)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="deadlift-weight-inc" className="text-gray-300">중량 증가 (예: 210kg→220kg→230kg, 5-10kg씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="reps_increase" id="deadlift-reps-inc" />
              <label htmlFor="deadlift-reps-inc" className="text-gray-300">Reps 증가 (중량 고정, 횟수 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="rpe_progression" id="deadlift-rpe-prog" />
              <label htmlFor="deadlift-rpe-prog" className="text-gray-300">RPE 점진 (예: RPE6→RPE8→RPE9, 1-2 RPE씩 증가)</label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="deadlift-straight" className="text-gray-300">Straight Sets (5x5, 3x5 같은 고정 중량/Reps)</label>
            </div>
            <div className="flex items-center space-x-2">
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case 5: return renderStep8();   // 현재 수준 (1RM, 경험)
      case 6: return renderStep5();   // 🚀 실패 패턴 분석
      case 7: return renderStep21_squatPreferences();  // 스쿼트 상세 훈련 선호도
      case 8: return renderStep22_benchPreferences();  // 벤치프레스 상세 훈련 선호도
      case 9: return renderStep23_deadliftPreferences(); // 데드리프트 상세 훈련 선호도
      case 10: return renderStep9();   // 목표 설정
      case 11: return renderStep15_injury(); // 부상 이력
      case 12: return renderStep6();   // 🧠 심리적 성향 분석
      case 13: return renderStep7();   // ⚡ 볼륨 내성 테스트
      case 14: return renderStep17_mental(); // 정신력 & 동기
      case 15: return renderStep18_sleep(); // 수면 패턴
      case 16: return renderStep19_nutrition(); // 영양 관리
      case 17: return renderStep10(); // 장비 및 환경
      case 18: return renderStep11(); // 훈련 블럭 선호도
      case 19: return renderStep12(); // 기술적 선호도
      case 20: return renderStep13(); // 약점 및 강점 분석
      case 21: return renderStep14(); // 기타 설정
      case 22: return renderStep16(); // 추가 정보
      case 23: return renderStep20_program(); // 프로그램 설정

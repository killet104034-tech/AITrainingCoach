...
const EXERCISES = {
  squat: {
    ...
    variations: [
      { name: "Pause Squat (2-sec)", difficulty: "beginner", tempo: "2-2-1" },
      { name: "Pause Squat (3-sec)", difficulty: "intermediate", tempo: "2-3-1" },
      { name: "Tempo Squat (3-1-1)", difficulty: "intermediate", tempo: "3-1-1" },
      { name: "Tempo Squat (4-2-1)", difficulty: "advanced", tempo: "4-2-1" },
  ...
  bench: {
    ...
    variations: [
      { name: "Pause Bench Press (1-sec)", difficulty: "beginner", tempo: "2-1-1" },
      { name: "Pause Bench Press (2-sec)", difficulty: "intermediate", tempo: "2-2-1" },
      { name: "Pause Bench Press (3-sec)", difficulty: "advanced", tempo: "2-3-1" },
      { name: "Tempo Bench Press (3-1-1)", difficulty: "intermediate", tempo: "3-1-1" },
      { name: "Tempo Bench Press (4-2-1)", difficulty: "advanced", tempo: "4-2-1" },
  ...
  deadlift: {
    ...
    variations: [
      { name: "Pause Deadlift (1-sec)", difficulty: "intermediate", tempo: "2-1-1" },
      { name: "Pause Deadlift (2-sec)", difficulty: "advanced", tempo: "2-2-1" },
      { name: "Tempo Deadlift (3-1-1)", difficulty: "intermediate", tempo: "3-1-1" },
